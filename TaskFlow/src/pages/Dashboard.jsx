            ...
            <div className="stats-grid">
                <div className="stat-card vibrant-total">
                    <div className="stat-icon">
                        <ListTodo size={24} color="var(--vibrant-total)" />
                    </div>
                ...
                <div className="stat-card vibrant-todo">
                    <div className="stat-icon">
                        <Clock size={24} color="var(--vibrant-todo)" />
                    </div>
                    <div className="stat-info">
                ...
                <div className="stat-card vibrant-progress">
                    <div className="stat-icon">
                        <Clock size={24} color="var(--vibrant-progress)" />
                    </div>
                    <div className="stat-info">
                ...
                <div className="stat-card vibrant-done">
                    <div className="stat-icon">
                        <CheckCircle size={24} color="var(--vibrant-done)" />
                    </div>
                    <div className="stat-info">
                ...
                <div className="stat-card vibrant-rate">
                    <div className="stat-icon">
                        <Target size={24} color="var(--vibrant-rate)" />
                    </div>
                    <div className="stat-info">
